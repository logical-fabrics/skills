...
| High | auth、billing、migration、data loss、security、production / infra、cross-slice architecture、広い UX / persistence | implementation、adversarial、必要な domain reviewer を分け、高難度統合は Fable / Sol へ escalation |
